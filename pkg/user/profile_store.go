...
func (s *MySQLStore) FetchProfileByUserID(ctx context.Context, id int) (profile *Profile, err error) {
...
func (s *MySQLStore) DeleteProfileByUserID(ctx context.Context, userID int) (err error) {
	if userID == 0 {
		return ErrZeroID
	}
