...
type Store interface {
	...
	DeleteEmailByAddr(ctx context.Context, userID uint32, addr string) (err error)
	...
	DeletePhoneByNumber(ctx context.Context, userID uint32, number string) (err error)
