...
type Store interface {
	...
	FetchUserByID(ctx context.Context, id int64) (u User, err error)
	...
	FetchPrimaryEmailByUserID(ctx context.Context, userID int64) (e Email, err error)
	FetchEmailByAddr(ctx context.Context, addr string) (e Email, err error)
	FetchEmailsByUserID(ctx context.Context, userID int64) (es []Email, err error)
	UpdateEmail(ctx context.Context, e Email, changelog diff.Changelog) (_ Email, err error)
	DeleteEmailByAddr(ctx context.Context, userID int64, addr string) (err error)

	// phones
	CreatePhone(ctx context.Context, p Phone) (_ Phone, err error)
	BulkCreatePhone(ctx context.Context, ps []Phone) (_ []Phone, err error)
	FetchPrimaryPhoneByUserID(ctx context.Context, userID int64) (p Phone, err error)
	FetchPhoneByNumber(ctx context.Context, number string) (p Phone, err error)
	FetchPhonesByUserID(ctx context.Context, userID int64) (ps []Phone, err error)
	UpdatePhone(ctx context.Context, p Phone, changelog diff.Changelog) (_ Phone, err error)
	DeletePhoneByNumber(ctx context.Context, userID int64, number string) (err error)
	...
	FetchProfileByUserID(ctx context.Context, userID int64) (p Profile, err error)
	UpdateProfile(ctx context.Context, p Profile, changelog diff.Changelog) (_ Profile, err error)
	DeleteProfileByUserID(ctx context.Context, userID int64) (err error)
}
