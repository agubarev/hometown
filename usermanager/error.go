...
var (
	...
	ErrUserNotEligible              = errors.New("user is not eligible for this operation")
	...
	ErrAccessPolicyKeyTaken         = errors.New("key is taken")
	...
	ErrNoID                         = errors.New("object has no ID")
